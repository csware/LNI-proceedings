...
\newcommandtwoopt{\addpaper}[5][DEF][DEF]{%
    ...
    \fancypagestyle{lniotherpages}{%
        \fancyhead{}
        %title on the right
        \fancyhead[RO]{\fontsize{9pt}{9pt}\selectfont \ifthenelse{\equal{#2}{DEF}}{#5}{#2}\hspace{5pt}\thepage\hspace{0.05cm}}
        %authors on the left
        \fancyhead[LE]{\hspace{0.05cm}\fontsize{9pt}{9pt}\selectfont\thepage\hspace{5pt}\ifthenelse{\equal{#1}{DEF}}{#4}{#1}}
